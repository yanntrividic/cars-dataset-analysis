...
Le 0.95 entre cylindre et cubinches signifie que le nombre de cylindres du véhicule (cubinches) joue pour 90,25% (0,95)\*(0,95) sur la valeur du volume moteur **[Yann : ce n'est pas vrai, une corrélation n'implique pas une causalité]**
...
Cela signifie que le dendrogramme résultant de la CAH comportera 261 feuilles ; la visualisation sera difficilement lisible et ce problème doit être abordé.
