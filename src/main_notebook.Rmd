...
```
Afin d'améliorer la lisiblité, il est possible de découper un dendrogramme, sur le graphique précédent, on distingue quatre groupes pour les seuils <15, on va utiliser ces groupes pour créer notre découpage.
...
fviz_dend(cah.ward, k=4, xlab="Individus", ylab="Seuil", main="Dendogramme découpé (factoextra)", 
