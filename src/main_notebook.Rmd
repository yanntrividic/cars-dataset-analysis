...
#TODO: ajouter doc
#' Fonction permettant d'afficher un graphique "scatterplot" de distribution des variables
#' 
#' @param scaledQuantitativeValues dataframe ne comportant que des valeurs quantitatives
#' @param cluster K-moyennes pour partitionné en plusieurs classes
